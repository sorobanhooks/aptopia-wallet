...
export const AccountTabs = ({
  ...
  // The new feature tabs (Yield Hub, Agent Dashboard) don't expose a manage
  // dropdown — they have nothing to add/remove at the tab level. Suppress the
  // gear icon entirely on those tabs instead of leaving a dead button.
  const showManageButton = isTokensTab || isCollectiblesTab;
  ...
  return (
    <div className="AccountTabs">
      ...
      <AccountHeaderModal
        ...
        isDropdownOpen={
          showManageButton && (isManageAssetsOpen || isAddCollectiblesOpen)
        }
        icon={
          showManageButton ? (
            <div
