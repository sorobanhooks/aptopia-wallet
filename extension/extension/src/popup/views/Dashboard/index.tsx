    ...
    return (
      <Wrapper>
        <div className="Dashboard__unconnected">
          ...
          >
            {t(
              "It looks like you don't have an AI agent associated with this wallet yet. Create one in seconds using Telegram.",
            )}
          </Text>
          ...
          <header className="Dashboard__header">
            <div className="Dashboard__header__left">
              ...
              <Heading
                as="h1"
                size="sm"
                addlClassName="Dashboard__header__title"
              >
                {t("Agent wallet")}
              </Heading>
            </div>
          ...
          <div className="Dashboard__card">
            <div className="Dashboard__card__address-row">
              ...
              >
                <span className="Dashboard__card__address">
                  {metrics?.agentAddress
                    ? truncatedPublicKey(metrics.agentAddress, 8)
                    : "..."}
                </span>
              </a>
              <CopyText
                textToCopy={metrics?.agentAddress || ""}
                doneLabel={t("Copied!")}
              >
            ...
            <div className="Dashboard__card__balances">
              <div className="Dashboard__card__balance-item">
                <span className="Dashboard__card__balance-label">
                  {t("USDC Balance")}
                </span>
            ...
            <div className="Dashboard__card__grid">
              <div className="Dashboard__card__stat">
                <span className="Dashboard__card__stat__label">
                  {t("Today's Spend")}
                </span>
          ...
          <div className="Dashboard__actions">
            {(metrics?.pendingTier2Count ?? 0) > 0 && (
              <Button
                ...
                iconPosition="left"
                onClick={() => navigateTo(ROUTES.confirmTrade, navigate)}
              >
                {t("Review Pending Trade")}
                <span className="Dashboard__actions__pending-badge">
                  {metrics?.pendingTier2Count}
                </span>
              </Button>
            )}
            <Button
                  ...
                  <div key={log._id} className="Dashboard__activity__item">
                    <div className="Dashboard__activity__item__content">
                      <div className="Dashboard__activity__item__top">
                        ...
                        <span
                          className={`Dashboard__activity__item__status Dashboard__activity__item__status--${log.status}`}
                        >
                          {log.status}
                        </span>
                      </div>
